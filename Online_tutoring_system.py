...
Available_lectures = ['1.TEACHER ADOLPHE', '2.TEACHER BERNARD',
                      '3.TEACHER MARY','4.TEACHER PATRICK','5.TEACHER EVODE']
    ...
    while True:
        ...
        if choice == 1:
            ...
            if session_info == 'SYSTEM ENGINEERING':
                ...
                print(f'\n{name} Booked {session_info} To be taught by TEACHER BERNARD')

            elif session_info == 'BUSINESS FUNCTION':
                print(f'\n{name} Booked {session_info} To be taught by TEACHER MARY')

            elif session_info == 'ESP':
                print(f'\n{name} Booked {session_info} To be taught by TEACHER PATRICK')

            elif session_info == 'DATABASE TECHNOLOGY':
                print(f'\n{name} Booked {session_info} To be taught by TEACHER EVODENUBY')
            else:
